      ...
      <div className="container mx-auto px-4 text-center">
        ...
        >
          ...
          <ContactForm
            ...
            buttonClassName="bg-[#d39a6a] hover:bg-[#d39a6a]/90 text-white text-lg px-8 py-6 h-auto flex items-center gap-2 mx-auto rounded-xl shadow-lg transition-all duration-300 inline-flex"
            buttonIcon={
              <svg
            ...
            title="מוכנים להתחיל את המסע לאילוף מקצועי?"
