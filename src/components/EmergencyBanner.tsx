    ...
    >
      <div className="container mx-auto px-4 flex sm:flex-row items-center justify-between gap-4 max-w-[1400px] flex-col">
        ...
        <div className="flex items-center gap-6">
          <ContactForm
            buttonText="צור קשר דחוף"
            buttonClassName="hover:bg-white/90 text-destructive text-base md:text-lg px-6 md:px-8 py-3 md:py-4 font-bold whitespace-nowrap flex items-center gap-2 shadow-lg hover:shadow-xl transition-all duration-300 active:scale-95 rounded-xl text-[3A5A40] text-[3A5A40] bg-[#124A34] text-[#ce9464]"
            buttonIcon={
              <motion.svg
            ...
            title="בעיית התנהגות דחופה?"
            description="השאירו פרטים ונחזור אליכם בהקדם האפשרי לטיפול בבעיה"
          />
        </div>
      </div>
    </motion.div>
